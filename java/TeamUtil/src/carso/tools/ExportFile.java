...
public class ExportFile {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while ((lineTxt = bufferedReader.readLine()) != null) {
                if(lineTxt.trim().isEmpty() || "#".equals(lineTxt.substring(0,1))) continue;
                projectName = lineTxt.split("/")[5];
    ...
    private static void exportFile(File file) {
        ...
        for (File srcFile : fileList) {
            ...
            parentFolderName = parentFolderName.replace("/Users/fangyj/Documents/classes/","");//parentFolderName.split("E:\\\\classes\\\\"+projectName + "\\\\");
            // 取出文件的父路径，添加到目标目录地址下
            String desFolder = desAddress + parentFolderName;
     ...
     * @param fileOutPut 将文件copy到那个目录下面 (此处为目录+要复制的文件名 例如C:\folder + \ + fileName)
     * @throws Exception
     */
