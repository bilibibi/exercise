...
public class StringHelper {
	...
	public static String sqlNameChangeToJavaName(String sqlName){
	    sqlName = uncapitalizeAll(sqlName);
	    String javaName = StringHelper.makeAllWordFirstLetterUpperCase(sqlName);
	    return uncapitalize(javaName);
	}
